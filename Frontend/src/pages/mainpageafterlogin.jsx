      ...
      <div style={styles.mainContent}>
        ...
        <div style={styles.leftSection}>
          ...
          <p style={styles.description}>
            Get company summaries, analyze debt ratings, view stock graphs &
            KPIs, and stay updated with the latest financial news – all in one
            powerful platform.
          </p>
        </div>
          ...
          <div style={styles.topRow}>
            <CustomTiltCard rotateAmplitude={15}>
              ...
              >
                ...
                <p style={styles.blockText}>
                  Instantly create financial summaries and reports using AI.
                </p>
            ...
            <CustomTiltCard rotateAmplitude={15}>
              <div style={styles.debtBlock}>
                ...
                <p style={styles.blockText}>
                  Get accurate and transparent debt analysis for smarter
                  decisions.
                </p>
              </div>
            </CustomTiltCard>
          ...
          <div style={styles.middleRow}>
            <CustomTiltCard rotateAmplitude={15}>
              <div style={styles.stockBlock}>
                ...
                <p style={styles.blockText}>
                  Analyze company stock trends and technical indicators.
                </p>
              </div>
            </CustomTiltCard>
          ...
          <div style={styles.bottomRow}>
            <CustomTiltCard rotateAmplitude={15}>
              <div style={styles.searchBlock}>
                ...
                <h3 style={{ ...styles.blockTitle, color: "#383838" }}>

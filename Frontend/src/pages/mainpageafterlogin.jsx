...
import { ChartCandlestick, BarChart3, PieChart, Search, Bot, HandCoins, User, History, Settings, LogOut } from 'lucide-react';
    ...
    <div style={styles.container}>
            ...
            {showDropdown && (
              <div style={styles.dropdown}>
                ...
                <div
                  ...
                  onClick={() => navigate("/homepage_beforelogin")} 
                >
                  <LogOut size={16} />
                  <span>Sign out</span>
                </div>
      ...
      <div style={styles.mainContent}>
        ...
        <div style={styles.leftSection}>
          <div style={styles.logo}>
            <img src={mainlogo} style={styles.MainlogoImage} alt="main logo" />
          </div>
          ...
          <div style={styles.topRow}>
            <CustomTiltCard rotateAmplitude={15}>
              ...
              onClick={() => {
                ...
                <p style={styles.blockText}>Instantly create financial summaries and reports using AI.</p>
            ...
            <CustomTiltCard rotateAmplitude={15}>
              <div style={styles.debtBlock}>
                ...
                <p style={styles.blockText}>Get accurate and transparent debt analysis for smarter decisions.</p>
              </div>
            </CustomTiltCard>
          </div>
          ...
          <div style={styles.middleRow}>
            <CustomTiltCard rotateAmplitude={15}>
              <div style={styles.stockBlock}>
                ...
                <p style={styles.blockText}>Analyze company stock trends and technical indicators.</p>
              </div>
            </CustomTiltCard>
            ...
            <CustomTiltCard rotateAmplitude={15}>
              <div style={styles.chartsBlock}>
                ...
                <p style={{ ...styles.blockText, color: '#1a1a1a' }}>Visualize company performance with real-time metrics.</p>
              </div>
            </CustomTiltCard>
          </div>
          ...
          <div style={styles.bottomRow}>
            <CustomTiltCard rotateAmplitude={15}>
              <div style={styles.searchBlock}>
                ...
                <p style={{ ...styles.blockText, color: '#383838' }}>Find detailed reports on any listed company in seconds.</p>
              </div>
            </CustomTiltCard>
          </div>
        </div>
